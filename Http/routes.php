...
Route::group(['middleware' => 'administrador','prefix'=>'admin'], function() {
        ...
        Route::get('configuracion', ['as' => 'configuracionAdmin', 'uses' =>'UserController@mostrarConfiguracion']);
        ...
        Route::get('vendedores',['as'=>'vendedoresAdmin', 'uses'=>'Administrador\VendedorController@index']);
        Route::get('agregarVendedor',['as'=>'agregarVendedor','uses'=>'Administrador\VendedorController@agregarVendedor']);
        Route::post('guardarVendedor',['as'=> 'guardarVendedor','uses'=>'Administrador\VendedorController@guardarVendedor']);
        Route::post('agregarSaldo/{vendedor}',['as'=>'agregarSaldo','uses'=>'Administrador\VendedorController@agregarSaldo'])->where('vendedor','[0-9]');
        Route::get('historialRecargasVendedor',['as'=>'historialRecargasVendedor','uses'=>'Administrador\VendedorController@historialRecargasVendedor']);
...
Route::group( ['middleware' => 'usuario','prefix'=>'usuario'], function() {
    ...
    Route::get('configuracion', ['as' => 'configuracionUsuario', 'uses' =>'UserController@mostrarConfiguracion']);
    //Rutas Saldo
...
#Ruta Propietario
    ...
    Route::group(['middleware' => 'propietario','prefix' => 'propietario'], function() {
        ...
        Route::get('configuracion', ['as' => 'configuracionPropietario', 'uses' =>'UserController@mostrarConfiguracion']);
         //Rutas Saldo
        ...
        Route::post('guardarLectorPropietario/{lector}',['as'=>'guardarLectorPropietario','uses'=>'Propietario\LectorController@guardarLectorPropietario']);
        //Route::
